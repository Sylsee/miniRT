...
/*   Updated: 2022/02/09 16:25:30 by spoliart         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
t_color	refraction(t_scene scene, t_vector ray, t_hit hit, int nb_rebound)
{
	...
	color.r = reflect_color.r * kr + refract_color.r * (1 - kr);
	color.g = reflect_color.g * kr + refract_color.g * (1 - kr);
	color.b = reflect_color.b * kr + refract_color.b * (1 - kr);
	return (color);
}
